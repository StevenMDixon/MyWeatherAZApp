  ...
  <body style=""background-color: #f6f6f6; font-family: sans-serif; -webkit-font-smoothing: antialiased; font-size: 14px; line-height: 1.4; margin: 0; padding: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;"">
    ...
    <table role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" class=""body"" style=""border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f6f6f6; width: 100%;"" width=""100%"" bgcolor=""#f6f6f6"">
      <tr>
        ...
        <td class=""container"" style=""font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; max-width: 800px; padding: 10px; width: 800px; margin: 0 auto;"" width=""580"" valign=""top"">
                  ...
                  <table role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" style=""border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;"" width=""100%"">
                    <tr>
                      <td style=""font-family: sans-serif; font-size: 14px; vertical-align: top;"" valign=""top"">
                        <p style=""font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"">Good Morning Steven,</p>
                        <p style=""font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;"">Here is your weather forecast for the day:</p>
                            ...
                            <tr>
                              <td align=""left"" style=""font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;"" valign=""top"">
                                <table role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" style=""border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;"">
                                  <tbody>
                                    <tr>
                                        <td>Currently the temperature is {{temp}}, the high will be {{temp_max}} and the low will be {{temp_min}} </td>
                                    ...
                                    <tr>
                                        <td>It looks like like the forecast for the day is: {{weather_forecast}}</td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
        ...
        "; 
        public static string GetEmailBody(WeatherData weatherData)
        {
            Handlebars.RegisterTemplate("css", css);
            ...
            var data = new
            {
                ...
                weather_forecast = weatherData.weather.FirstOrDefault().description
            };
